[![Run App NickScott](https://github.com/TensorHusker/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/TensorHusker/GithubActions/actions/workflows/run-app.yaml)
